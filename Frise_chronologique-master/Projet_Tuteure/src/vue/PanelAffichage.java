...
/**
 * Ce panel est la deuxième Frame importante, qui affiche les informations de la
 * frise et qui possède donc le nom de la frise, la table et le diapo
 * 
 */
public class PanelAffichage extends JPanel {
	...
	/** methode qui affiche <strong>l'evenement précedent</strong>
	 * 
	 */
	 ...
	 * 
	 *  
	 * @return l'annee de l'evenmeent qui est affiché dans la diapo
	 */
