...
public class PanelCreation extends JPanel{
	...
	/**
	 * 
	 * @return l'evenemnet qui est du coup cree avec les champs de texte
	 */
	...
	/**
	 * 
	 * @return la date qui est du coup crée sur les différents champs à sa demande
	 */
	public Date getDate(){
